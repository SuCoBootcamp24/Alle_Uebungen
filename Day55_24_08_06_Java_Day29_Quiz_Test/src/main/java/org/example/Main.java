...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Anzahl der richtigen Antworten: " + correctAnswers + " von " + quiz.getQuestionList().size());
        System.out.println("Sie ein Gesammtscore von " + user.getScore() + " erreicht");
